const STRINGS = {
  en: {
    ...
    inspectionCommandDetail: 'Each node opens its engineering case.',
    nodeInspect: 'INSPECT →',
    nodeActive: 'CASE OPEN',
    mobileMapHint: 'Swipe to navigate · tap to inspect',
  ...
  'pt-BR': {
    ...
    inspectionCommandDetail: 'Cada nó abre seu caso de engenharia.',
    nodeInspect: 'INSPECIONAR →',
    nodeActive: 'CASO ABERTO',
    mobileMapHint: 'Deslize para navegar · toque para inspecionar',
