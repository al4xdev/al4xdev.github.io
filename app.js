const STRINGS = {
  en: {
    ...
    cvRendererNote: 'Download the verified A4 PDF generated by the publication pipeline.',
    cvToggle: 'CV / PDF',
    cvDownload: 'Download official CV',
  ...
  'pt-BR': {
    ...
    cvRendererNote: 'Baixe o PDF A4 verificado e gerado pelo pipeline de publicação.',
    cvToggle: 'CV / PDF',
    cvDownload: 'Baixar currículo oficial',
...
function translateInterface() {
  ...
  const cvDownload = document.querySelector('[data-download-cv]');
  if (cvDownload) {
    const filename = language === 'pt-BR'
      ? 'alexsandro-pessoa-cv-pt-BR.pdf'
      : 'alexsandro-pessoa-cv-en.pdf';
    cvDownload.href = `cv/${filename}`;
    cvDownload.download = filename;
  }
