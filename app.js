const STRINGS = {
  en: {
    ...
    systemsIntro: 'Tap or click any system below to open its case: the problem, the design decision, and the evidence.',
    mapLabel: 'Interactive map of selected projects',
    legendSelected: 'Selected system',
    legendRelation: 'Shared design concern',
    inspectionCommand: 'CHOOSE A SYSTEM',
    nodeInspect: 'INSPECT →',
    nodeActive: 'CASE OPEN',
    mobileMapHint: 'Swipe to navigate',
  ...
  'pt-BR': {
    ...
    systemsIntro: 'Toque ou clique em qualquer sistema abaixo para abrir seu caso: o problema, a decisão de design e as evidências.',
    ...
    inspectionCommand: 'ESCOLHA UM SISTEMA',
    nodeInspect: 'INSPECIONAR →',
    nodeActive: 'CASO ABERTO',
    mobileMapHint: 'Deslize para navegar',
